...
const stepsContent = [
  {
    texto:
      "Recibes un correo supuestamente de tu proveedor de internet que indica: Tu factura está pendiente. Haz clic aquí para evitar la suspensión del servicio",
    imagen: "assets/img/card.png",
  },
  {
    texto: [
      "El enlace te lleva a una página falsa que solicita tus credenciales de usuario y tus datos bancarios, robando esta información para cometer fraudes.",
    ],
