...
const stepsContent = [
  {
    texto:
      "Recibes un correo con un archivo adjunto infectado que cifra tus documentos.",
    imagen: "assets/img/card.png",
  },
  {
    texto: [
      "Tus archivos son inaccesibles y los atacantes piden un rescate en criptomonedas.",
    ],
